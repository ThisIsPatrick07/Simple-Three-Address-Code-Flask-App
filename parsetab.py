...
_lr_productions = [
  ...
  ('param_list -> param_list COMMA param','param_list',3,'p_param_list','tac.py',115),
  ('param_list -> param','param_list',1,'p_param_list','tac.py',116),
  ('param -> INT ID','param',2,'p_param','tac.py',123),
  ('declarations -> declarations declaration','declarations',2,'p_declarations','tac.py',127),
  ('declarations -> empty','declarations',1,'p_declarations','tac.py',128),
  ('declaration -> INT ID ASSIGN expression SEMI','declaration',5,'p_declaration','tac.py',132),
  ('declaration -> INT ID SEMI','declaration',3,'p_declaration','tac.py',133),
  ('statements -> statements statement','statements',2,'p_statements','tac.py',140),
  ('statements -> empty','statements',1,'p_statements','tac.py',141),
  ('statement -> ID ASSIGN expression SEMI','statement',4,'p_statement_expr','tac.py',145),
  ('statement -> PRINT LPAREN expression RPAREN SEMI','statement',5,'p_statement_expr','tac.py',146),
  ('statement -> RETURN expression SEMI','statement',3,'p_statement_return','tac.py',157),
  ('expression -> expression PLUS expression','expression',3,'p_expression_binop','tac.py',161),
  ('expression -> expression MINUS expression','expression',3,'p_expression_binop','tac.py',162),
  ('expression -> expression TIMES expression','expression',3,'p_expression_binop','tac.py',163),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression_binop','tac.py',164),
  ('expression -> LPAREN expression RPAREN','expression',3,'p_expression_group','tac.py',173),
  ('expression -> NUMBER','expression',1,'p_expression_number','tac.py',177),
  ('expression -> ID','expression',1,'p_expression_id','tac.py',183),
  ('expression -> ID LPAREN arguments RPAREN','expression',4,'p_expression_call','tac.py',187),
  ('arguments -> arguments COMMA expression','arguments',3,'p_arguments','tac.py',198),
  ('arguments -> expression','arguments',1,'p_arguments','tac.py',199),
  ('empty -> <empty>','empty',0,'p_empty','tac.py',206),
]
